...
.method public static checkTerminated(ZZLeb/c;ZLio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/internal/util/QueueDrain;)Z
    .locals 2
    ...
    .line 4
    invoke-interface {p2, p0}, Leb/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    .line 5
    :cond_1
    invoke-interface {p2}, Leb/c;->onComplete()V
...
.method public static drainMaxLoop(Lio/reactivex/internal/fuseable/SimplePlainQueue;Leb/c;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 22
    invoke-static/range {v2 .. v7}, Lio/reactivex/internal/util/QueueDrainHelper;->checkTerminated(ZZLeb/c;ZLio/reactivex/internal/fuseable/SimpleQueue;Lio/reactivex/internal/util/QueueDrain;)Z
    ...
    .line 53
    .line 54
    invoke-interface {p4, p1, v8}, Lio/reactivex/internal/util/QueueDrain;->accept(Leb/c;Ljava/lang/Object;)Z
    ...
    .line 89
    .line 90
    invoke-interface {p1, p0}, Leb/c;->onError(Ljava/lang/Throwable;)V
...
.method public static postComplete(Leb/c;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 6
    .line 7
    invoke-interface {p0}, Leb/c;->onComplete()V
    ...
    .line 21
    .line 22
    invoke-static/range {v1 .. v6}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLeb/c;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    ...
    .line 64
    .line 65
    invoke-static/range {v9 .. v14}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLeb/c;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
...
.method public static postCompleteDrain(JLeb/c;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 27
    :cond_2
    invoke-interface {p2, v5}, Leb/c;->onNext(Ljava/lang/Object;)V
...
.method public static postCompleteRequest(JLeb/c;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 42
    .line 43
    invoke-static/range {v8 .. v13}, Lio/reactivex/internal/util/QueueDrainHelper;->postCompleteDrain(JLeb/c;Ljava/util/Queue;Ljava/util/concurrent/atomic/AtomicLong;Lio/reactivex/functions/BooleanSupplier;)Z
...
.method public static request(Leb/d;I)V
    .locals 2
    ...
    .line 10
    :goto_0
    invoke-interface {p0, v0, v1}, Leb/d;->request(J)V
