...
.field private mOnReplayListener:Ltv/danmaku/ijk/media/player/IMediaPlayer$OnReplayListener;

.field private mOnSeekCompleteListener:Ltv/danmaku/ijk/media/player/IMediaPlayer$OnSeekCompleteListener;

.field private mOnSeekListener:Ltv/danmaku/ijk/media/player/IMediaPlayer$OnSeekListener;
...
.method public final notifyOnBufferingUpdate(I)V
    ...
    .line 2
    invoke-interface {v0, p0, p1, v1, v2}, Ltv/danmaku/ijk/media/player/IMediaPlayer$OnBufferingUpdateListener;->onBufferingUpdate(Ltv/danmaku/ijk/media/player/IMediaPlayer;IJ)V

    :cond_0
    return-void
.end method

.method public final notifyOnBufferingUpdate(IJ)V
    .locals 1
    ...
    .line 4
    invoke-interface {v0, p0, p1, p2, p3}, Ltv/danmaku/ijk/media/player/IMediaPlayer$OnBufferingUpdateListener;->onBufferingUpdate(Ltv/danmaku/ijk/media/player/IMediaPlayer;IJ)V
...
.method public final notifyOnReplay()V
    .locals 1

    .line 1
    iget-object v0, p0, Ltv/danmaku/ijk/media/player/AbstractMediaPlayer;->mOnReplayListener:Ltv/danmaku/ijk/media/player/IMediaPlayer$OnReplayListener;
    ...
    .line 4
    .line 5
    invoke-interface {v0, p0}, Ltv/danmaku/ijk/media/player/IMediaPlayer$OnReplayListener;->onReplay(Ltv/danmaku/ijk/media/player/IMediaPlayer;)V
...
.method public final notifyOnSeek(J)V
    .locals 1

    .line 1
    iget-object v0, p0, Ltv/danmaku/ijk/media/player/AbstractMediaPlayer;->mOnSeekListener:Ltv/danmaku/ijk/media/player/IMediaPlayer$OnSeekListener;
    ...
    .line 4
    .line 5
    invoke-interface {v0, p0, p1, p2}, Ltv/danmaku/ijk/media/player/IMediaPlayer$OnSeekListener;->onSeek(Ltv/danmaku/ijk/media/player/IMediaPlayer;J)V
...
.method public resetListeners()V
    ...
    .line 17
    .line 18
    iput-object v0, p0, Ltv/danmaku/ijk/media/player/AbstractMediaPlayer;->mOnReplayListener:Ltv/danmaku/ijk/media/player/IMediaPlayer$OnReplayListener;
...
.method public final setOnReplayListener(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnReplayListener;)V
    .locals 0

    .line 1
    iput-object p1, p0, Ltv/danmaku/ijk/media/player/AbstractMediaPlayer;->mOnReplayListener:Ltv/danmaku/ijk/media/player/IMediaPlayer$OnReplayListener;
...
.method public final setOnSeekListener(Ltv/danmaku/ijk/media/player/IMediaPlayer$OnSeekListener;)V
    .locals 0

    .line 1
    iput-object p1, p0, Ltv/danmaku/ijk/media/player/AbstractMediaPlayer;->mOnSeekListener:Ltv/danmaku/ijk/media/player/IMediaPlayer$OnSeekListener;
