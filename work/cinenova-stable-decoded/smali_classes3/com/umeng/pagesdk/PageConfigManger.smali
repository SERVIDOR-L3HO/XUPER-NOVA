...
.method public constructor <init>(Landroid/content/Context;Lcom/efs/sdk/base/EfsReporter;)V
    ...
    iput v1, v0, Lcom/umeng/pagesdk/PageConfigManger;->d:I

    const/4 v2, 0x0

    iput v2, v0, Lcom/umeng/pagesdk/PageConfigManger;->e:I

    iput-boolean v2, v0, Lcom/umeng/pagesdk/PageConfigManger;->g:Z

    invoke-virtual/range {p1 .. p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v3

    iput-object v3, v0, Lcom/umeng/pagesdk/PageConfigManger;->b:Landroid/content/Context;

    move-object/from16 v4, p2

    iput-object v4, v0, Lcom/umeng/pagesdk/PageConfigManger;->c:Lcom/efs/sdk/base/EfsReporter;
    ...
    const-string v5, "apm_pageperf_sampling_rate_last"
    ...
    iput v3, v0, Lcom/umeng/pagesdk/PageConfigManger;->f:I

    :cond_0
    iget-object v3, v0, Lcom/umeng/pagesdk/PageConfigManger;->b:Landroid/content/Context;

    invoke-virtual {v3, v4, v2}, Landroid/content/Context;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;

    move-result-object v3

    const-string v6, "apm_pageperf_sampling_rate"
    ...
    :goto_0
    iget-object v8, v0, Lcom/umeng/pagesdk/PageConfigManger;->c:Lcom/efs/sdk/base/EfsReporter;

    const-string v9, "apm_pageperf_collect_interval_together"

    const-string v10, "apm_pageperf_collect_max_period_sec"

    const-string v11, "apm_pageperf_collect_interval"

    filled-new-array {v6, v11, v9, v10}, [Ljava/lang/String;

    move-result-object v6

    new-instance v9, Lcom/umeng/pagesdk/PageConfigManger$1;

    invoke-direct {v9, v0}, Lcom/umeng/pagesdk/PageConfigManger$1;-><init>(Lcom/umeng/pagesdk/PageConfigManger;)V
    ...
    iput v3, v0, Lcom/umeng/pagesdk/PageConfigManger;->d:I
    ...
    :goto_2
    iget v14, v0, Lcom/umeng/pagesdk/PageConfigManger;->d:I
    ...
    :cond_8
    iget v3, v0, Lcom/umeng/pagesdk/PageConfigManger;->f:I
    ...
    iget v9, v0, Lcom/umeng/pagesdk/PageConfigManger;->d:I
    ...
    sget-object v1, Lcom/umeng/pagesdk/PageManger;->TAG:Ljava/lang/String;
    ...
    :cond_11
    :goto_9
    iput-boolean v6, v0, Lcom/umeng/pagesdk/PageConfigManger;->g:Z
