...
.method public reportError([Leb/c;Ljava/lang/Throwable;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    .line 6
    .line 7
    invoke-static {p2, v2}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Leb/c;)V
...
.method public subscribe([Leb/c;)V
    ...
    .line 31
    .line 32
    invoke-direct {v4, v5, v3, v6}, Lio/reactivex/internal/operators/parallel/ParallelCollect$ParallelCollectSubscriber;-><init>(Leb/c;Ljava/lang/Object;Lio/reactivex/functions/BiConsumer;)V
    ...
    .line 43
    .line 44
    invoke-virtual {p0, p1, v0}, Lio/reactivex/internal/operators/parallel/ParallelCollect;->reportError([Leb/c;Ljava/lang/Throwable;)V
