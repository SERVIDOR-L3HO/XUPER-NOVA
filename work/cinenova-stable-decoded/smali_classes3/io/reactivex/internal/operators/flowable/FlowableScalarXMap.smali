...
.method public static tryScalarXMapSubscribe(Leb/b;Leb/c;Lio/reactivex/functions/Function;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 47
    .line 48
    invoke-direct {p2, p1, p0}, Lio/reactivex/internal/subscriptions/ScalarSubscription;-><init>(Leb/c;Ljava/lang/Object;)V

    .line 49
    .line 50
    .line 51
    invoke-interface {p1, p2}, Leb/c;->onSubscribe(Leb/d;)V
    ...
    .line 58
    .line 59
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Leb/c;)V
    ...
    .line 63
    :cond_2
    invoke-interface {p0, p1}, Leb/b;->subscribe(Leb/c;)V
